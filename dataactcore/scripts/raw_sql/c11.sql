...
WITH award_financial_c11_16410 AS
    ...
    WHERE submission_id = 16410),
award_procurement_c11_16410 AS
    (SELECT piid,
        parent_award_id
...
SELECT
    ...
    af.piid,
    af.parent_award_id
FROM award_financial_c11_16410 AS af
WHERE af.transaction_obligated_amou IS NOT NULL
    ...
    AND ((af.parent_award_id IS NULL
            AND NOT EXISTS (
              SELECT 1
              FROM award_procurement_c11_16410 AS ap
